...
Tree::Node::Node(int id) : parent(NULL), pos_in_parent(NONE), id(id), secondary_id(id), taxa(NONE), weight(0), leaf_size(0), node_size(0), depth(0) {}
Tree::Node::Node(int id, int taxa) : parent(NULL), pos_in_parent(NONE), id(id), secondary_id(id), taxa(taxa), weight(0), leaf_size(0), node_size(0), depth(0) {}
...
//	if (!is_root()) {
	ss << ", weight: " << weight << ", orig_w: " << orig_w << ", sec id: " << secondary_id;
	// ss << ", label: " << label << ", sec id: " << secondary_id;
//	}
	return ss.str();
}
